...
public class ExpImpl extends MinimalEObjectImpl.Container implements Exp
{
   ...
   * @ordered
   */
  protected dk.sdu.mmmi.mdsd.math.Number left;
   ...
   */
  @Override
  public dk.sdu.mmmi.mdsd.math.Number getLeft()
  {
    return left;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetLeft(dk.sdu.mmmi.mdsd.math.Number newLeft, NotificationChain msgs)
  {
    dk.sdu.mmmi.mdsd.math.Number oldLeft = left;
    left = newLeft;
   ...
   */
  @Override
  public void setLeft(dk.sdu.mmmi.mdsd.math.Number newLeft)
  {
    if (newLeft != left)
    {
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case MathPackage.EXP__LEFT:
        setLeft((dk.sdu.mmmi.mdsd.math.Number)newValue);
        return;
      case MathPackage.EXP__OPERATOR:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case MathPackage.EXP__LEFT:
        setLeft((dk.sdu.mmmi.mdsd.math.Number)null);
        return;
      case MathPackage.EXP__OPERATOR:
